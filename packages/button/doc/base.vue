<template>
    ...
    <div class="x-base">
        ...
        <x-button type="primary" round>主题按钮</x-button>
        ...
        <x-button type="text" round>文字按钮</x-button>
    </div>
    <div class="x-base">
        <x-button plain>默认按钮</x-button>
        <x-button type="primary" plain>主题按钮</x-button>
        ...
        <x-button type="text" plain>文字按钮</x-button>
    </div>
</template>

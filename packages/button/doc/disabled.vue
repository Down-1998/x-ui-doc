<template>
    <div>
        ...
        <x-button type="primary" disabled>主题按钮</x-button>
    ...
    <div>
        <x-button plain disabled>默认按钮</x-button>
        <x-button type="primary" plain disabled>主题按钮</x-button>
        ...
        <x-button type="text" plain disabled>文字按钮</x-button>
    </div>
</template>
